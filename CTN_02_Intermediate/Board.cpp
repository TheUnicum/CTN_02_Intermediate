...
void Board::DrawCell(const Location& loc, Color c)
{
	...
	gfx.DrawRecDim(loc.x * dimension + off_x + cellPadding, loc.y * dimension + off_y + cellPadding, dimension - cellPadding * 2, dimension - cellPadding * 2, c);
}
...
void Board::DrawBorder()
{
	...
	// top
	gfx.DrawRec(left, top, right, top + borderWidth, borderColor);
	// left
	gfx.DrawRec(left, top + borderWidth, left + borderWidth, bottom - borderWidth, borderColor);
	// right
	gfx.DrawRec(right - borderWidth , top + borderWidth, right, bottom - borderWidth, borderColor);
	// bottom
	gfx.DrawRec(left, bottom - borderWidth, right, bottom, borderColor);
}
